...
const redirectUri = process.env.NODE_ENV === 'production' ? process.env.production.REACT_APP_PROD_REDIRECT_URI : process.env.development.REACT_APP_DEV_REDIRECT_URI;
;
const scopes = [
